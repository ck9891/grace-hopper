...
function WiredComponent() {
  return (
    <div className="wired-component">
      <svg
      ...
      >
        ...
        />
        <path
          style={{fill:'none', stroke:'#1a5336', strokeMiterlimit:10, strokeWidth:'3px'}}
        ...
        />
        <path
          style={{fill:"#fff", stroke:"#1a5336", strokeMiterlimit:10, strokeWidth:"3px"}}
          d="M79.25 16.209h40.965"
        />
        <path
          d="M104.642 36.297a5.058 5.058 0 0 1 5.058 5.058l-7.031 31.172"
          style={{fill:"none", stroke:"#1a5336", strokeLinejoin:"bevel", strokeWidth:"3px"}}
        />
      </svg>
      <h1>
        Get <em>Wired</em> with TD!
      </h1>
    </div>
  );
}

export default WiredComponent;
